...
export default function ProfileCellArchitecture() {
  return (
      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-emerald-900 mb-4 text-center">
            Profile Cell - Architecture
          </h1>
          <p className="text-lg text-emerald-800 text-center mb-6">
            Diagrama de componentes y arquitectura de la célula Profile
          </p>
          
          {/* Card para ir a documentación API */}
          <div className="flex justify-center mb-6">
            <a
              href="/Documentation/profile-cell"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-teal-800/70 backdrop-blur-xl hover:bg-teal-900/80 text-white px-8 py-4 rounded-2xl font-semibold transition-all hover:scale-105 shadow-xl flex items-center gap-3 border border-white/30"
            >
              <span className="text-2xl">📚</span>
              <div>
                <div className="font-bold text-lg">API Documentation</div>
                <div className="text-sm text-teal-100">Ver documentación REST & GraphQL</div>
              </div>
            </a>
          </div>
        </div>
        ...
        <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-6 border border-white/50 shadow-2xl">
          <iframe 
            src="https://s.icepanel.io/m2wHcs0VDGoam5/QOT2" 
            height="800" 
            width="100%" 
            title="Profile Cell Architecture Diagram" 
